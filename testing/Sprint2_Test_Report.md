...
* To verify that registered users can log into the system successfully.
* To ensure that incorrect login credentials are handled properly.

**2. Search**

* To test whether users can search for courses or tutors within the platform.
* To confirm that relevant results appear when a subject is searched.
