...
The objective of this testing process was to evaluate the functionality and usability of the EduConnect mobile application prototype. The testing focused on verifying whether the core features of the system operate correctly and provide a smooth user experience for users.
...
To ensure that required fields such as email and password are properly captured and validated.
...
Open the EduConnect registration page.

Leave one or more required fields (e.g., email) empty.
...
Open the EduConnect login page.
...
Open the EduConnect prototype.

Navigate to the Algebra 101 course.

Scroll to the Quiz 1: Pre-test section.
